...
#' @examples plt_list_update(client_id = client_id,
#'   secret = secret,
#'   project_id = 123,
#'   list_id = 5,
#'   body = body)
...
plt_list_update <- function(client_id, secret, project_id, list_id, body) {
  ...
  data <- httr::content(
    httr::PUT(url = paste0('https://api.domo.com/v1/projects/',project_id,'/lists/',list_id),
              body = body,
