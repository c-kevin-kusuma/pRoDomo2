...
#' @examples
#' plt_attachment_get(client_id = client_id,
#'   secret = secret,
#'   project_id = 123,
#'   list_id = 5,
#'   task_id = 12)
...
plt_attachment_get <- function(client_id, secret, project_id, list_id, task_id) {
  ...
  data <- httr::content(
    httr::GET(url = paste0('https://api.domo.com/v1/projects/',project_id,'/lists/',list_id,'/task_id/',task_id, '/attachments'),
