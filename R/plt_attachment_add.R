...
#' @param body The content of the attachment. Please refer to the documentation for details.
#' @examples
...
plt_attachment_add <- function(client_id, secret, project_id, list_id, task_id, body) {
  ...
  data <- httr::content(
    httr::POST(url = paste0('https://api.domo.com/v1/projects/',project_id,'/lists/',list_id,'/task_id/',task_id, '/attachments'),
              body = body,
