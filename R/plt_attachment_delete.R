...
plt_attachment_delete <- function(client_id, secret, project_id, list_id, task_id, attachment_id) {
  ...
  data <- httr::content(
    httr::DELETE(url = paste0('https://api.domo.com/v1/projects/',project_id,'/lists/',list_id,'/task_id/',task_id,'/attachments/',attachment_id),
